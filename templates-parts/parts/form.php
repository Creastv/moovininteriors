<?php if(is_singular( 'mieszkania' ) || is_page(12)) { ?>
<?php
$headline = get_field('hedline_realizacje', 'options');
$subhead = get_field('subhead_realizacje', 'options');
$img = get_field('img_realizacje', 'options');
$desc = get_field( 'desc_realizacje', 'options');
?>
<div class="b-form">
    <div class="container">
        <div class="row">

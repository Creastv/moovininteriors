...
$headline = get_field('headline_get_know', 'options');
$desc = get_field('desc_get_know', 'options');
$linkStyle = get_field('link_style', 'options');
$link = get_field('button_get_know', 'options');
if( $link ){
    $link_url = $link['url'];
